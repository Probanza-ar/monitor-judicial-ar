#!/usr/bin/env node
/**
 * parte-diario-pjn.v2.mjs - Parte diario de novedades del Portal PJN por email.
 *
 * Version 2. Mantiene la logica original (login por navegador real, captura del
 ...
 *
 * No agrega dependencias: sigue usando solo puppeteer + nodemailer.
 *
 * Config: copiar .env (o .env.v2.example) y completar. El .env NO se commitea.
 * Uso manual (prueba):  node parte-diario-pjn.v2.mjs
 *
...
const CFG = {
  ...
  // Sugerencia: apuntar al Escritorio, ej. C:\Users\Ximena\Desktop
